...
import ThreeDimensionalThinkingNote from './3D Thinking Components/ThreeDimensionalThinkingNote';
import { Introduction, Step1Code, Step2Code, Step3Code, OtherNotes } from './3D Thinking Components/ThreeDimensionalThinkingCode';
        ...
        <>
            <div className="newGrid container mt-3">
                <div className="row">
                    ...
                    {/* Step 3 */}
                    <h3 className="cardDescription col-2">Other Note:</h3>
                    <div className="col-10 ">
                        <div className="row">
                            <h4 className="col-12 cardAction p-3">Preserving 3D in Nested Objects</h4>
                            <ThreeDimensionalThinkingNote />
                            <OtherNotes />
                        </div>
                    </div>
                </div>
