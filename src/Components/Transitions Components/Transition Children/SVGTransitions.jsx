export default function SVGTransitions({ start, svgStart }) {
    ...
    return (
        <div className="center" style={styles.grandparent}>
            <div style={styles.parent} className={start}>
                <svg className={svgStart} style={{ height: "150px", width: "150px" }} viewBox="0 0 24 24">
